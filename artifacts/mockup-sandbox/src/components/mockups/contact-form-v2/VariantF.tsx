...
export function VariantF() {
  return (
    <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", background: CREAM, minHeight: "100vh", padding: "72px 32px" }}>
      ...
      {/* Bold section header */}
      <div style={{ maxWidth: "1040px", margin: "0 auto 48px" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "16px" }}>
          <div>
            ...
            <h2 style={{ fontSize: "40px", fontWeight: 900, color: NAVY, letterSpacing: "-2px", lineHeight: 1.06, margin: 0 }}>
          ...
          <div style={{ display: "flex", gap: "32px" }}>
            {[
              ...
              <div key={stat.label} style={{ textAlign: "center" }}>
                <div style={{ fontSize: "26px", fontWeight: 900, color: ACCENT, letterSpacing: "-1px" }}>{stat.val}</div>
      ...
      {/* 2-column grid */}
      <div style={{ maxWidth: "1040px", margin: "0 auto", display: "grid", gridTemplateColumns: "1.05fr 0.95fr", gap: "32px", alignItems: "start" }}>

        {/* LEFT — Form card */}
        <div style={{ background: "white", borderRadius: "20px", padding: "36px", boxShadow: `0 4px 40px ${NAVY}07`, border: `1px solid ${NAVY}08` }}>

          {/* Role toggle */}
          <div style={{ display: "flex", gap: "8px", marginBottom: "24px", background: CREAM, borderRadius: "14px", padding: "4px" }}>
            {[
              { label: "Ik zoek versterking", active: true },
              { label: "Ik ben professional", active: false },
            ].map(opt => (
              <button key={opt.label} style={{
                flex: 1, background: opt.active ? NAVY : "transparent", color: opt.active ? "white" : `${NAVY}60`,
                border: "none", borderRadius: "10px", padding: "10px 12px", cursor: "pointer",
          ...
          <div style={{ marginBottom: "22px" }}>
            ...
            <textarea rows={4} placeholder="Vertel ons kort over uzelf..." style={{ ...inputStyle, resize: "none" }} />
          </div>
          <button style={{ width: "100%", background: NAVY, color: "white", border: "none", borderRadius: "100px", padding: "15px", fontSize: "14px", fontWeight: 700, cursor: "pointer", boxShadow: `0 8px 28px ${NAVY}25`, letterSpacing: "-0.2px" }}>
            Verstuur bericht <span style={{ color: ACCENT }}>→</span>
          </button>
        </div>

        {/* RIGHT — Agency-style profile column */}
        <div style={{ display: "flex", flexDirection: "column", gap: "0" }}>

          {/* Photo + intro card */}
          <div style={{ background: "white", borderRadius: "20px", padding: "32px", marginBottom: "16px", boxShadow: `0 4px 24px ${NAVY}06`, border: `1px solid ${NAVY}07` }}>
            <div style={{ display: "flex", alignItems: "center", gap: "18px", marginBottom: "20px" }}>
              <div style={{ width: "72px", height: "72px", borderRadius: "50%", overflow: "hidden", border: `2.5px solid ${ACCENT}`, flexShrink: 0 }}>
                <img src="/Nick_1779994992412.png" alt="Nicky" style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "50% 10%" }} />
              </div>
              <div>
                <div style={{ fontSize: "17px", fontWeight: 800, color: NAVY, letterSpacing: "-0.4px" }}>Nicky</div>
                <div style={{ fontSize: "10.5px", fontWeight: 700, color: ACCENT, letterSpacing: "1.2px", textTransform: "uppercase", marginTop: "3px" }}>Recruitment & Detachering</div>
            ...
            <div style={{ borderLeft: `3px solid ${ACCENT}`, paddingLeft: "16px" }}>
              <p style={{ fontSize: "14.5px", lineHeight: 1.7, color: `${NAVY}85`, fontWeight: 500, margin: 0, fontStyle: "italic" }}>
          ...
          {/* CTA card */}
          <div style={{ background: NAVY, borderRadius: "20px", padding: "28px 28px", boxShadow: `0 8px 32px ${NAVY}20`, position: "relative", overflow: "hidden" }}>
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              <p style={{ fontSize: "15px", fontWeight: 700, color: "white", lineHeight: 1.6, margin: "0 0 16px 0" }}>
          ...
          <div style={{ display: "flex", gap: "12px", marginTop: "14px" }}>
            {[
              ...
              <div key={item.label} style={{ flex: 1, background: "white", borderRadius: "12px", padding: "12px 14px", border: `1px solid ${NAVY}08` }}>
                ...
                <div style={{ fontSize: "12px", fontWeight: 700, color: NAVY }}>{item.val}</div>
              </div>
            ))}
          </div>
        </div>
