...
export function VariantB() {
  return (
    <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", background: NAVY, minHeight: "100vh", position: "relative", overflow: "hidden", display: "flex", flexDirection: "column" }}>
      ...
      {/* Full-bleed image — right ~65%, positioned absolutely */}
      <div style={{ position: "absolute", top: 0, right: 0, width: "65%", height: "100%", zIndex: 1 }}>
        ...
        <div style={{
          ...
          background: `linear-gradient(to right, ${NAVY} 0%, ${NAVY}E0 10%, ${NAVY}90 35%, transparent 70%)`
        }} />
        {/* Top darkening */}
        <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to bottom, rgba(23,42,78,0.45) 0%, transparent 40%)" }} />
      </div>

      {/* Dot grid — left half only */}
      <div style={{
        position: "absolute", top: 0, left: 0, width: "50%", height: "100%", zIndex: 2, pointerEvents: "none",
        backgroundImage: "radial-gradient(rgba(255,255,255,0.035) 1px, transparent 1px)",
        backgroundSize: "28px 28px"
      }} />

      {/* Nav */}
      <nav style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 56px", height: "72px", flexShrink: 0, position: "relative", zIndex: 30 }}>
        ...
        <button style={{ background: "transparent", color: "#fff", border: "1.5px solid rgba(255,255,255,0.3)", borderRadius: "100px", padding: "10px 24px", fontSize: "13px", fontWeight: 600, cursor: "pointer" }}>
          Plan een gesprek
        </button>
      </nav>
      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", padding: "0 56px 80px 72px", position: "relative", zIndex: 10 }}>
        <div style={{ maxWidth: "620px" }}>
          ...
          {/* Very large headline ~96px, overlapping the image */}
          <h1 style={{
            ...
            De juiste<br />
            professionals<span style={{ color: ACCENT }}>.</span>
          </h1>

          {/* Minimal sub */}
          <p style={{ fontSize: "17px", lineHeight: 1.7, color: "rgba(255,255,255,0.50)", margin: "0 0 44px 0", maxWidth: "440px" }}>
          ...
          <div style={{ display: "flex", gap: "14px", alignItems: "center" }}>
            <button style={{
              ...
              borderRadius: "100px", padding: "18px 40px",
